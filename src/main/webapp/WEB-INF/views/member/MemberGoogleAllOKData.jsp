...
<body>
	...
	<div align='center'>
		<div align='left'
			style="border: 3px solid gray; width: 500; height: 500; border-radius: 5px;">
			<form action="<c:url value='/member/Update'/>" method="post">
				...
				<h3>
					<c:choose>
						...
						<c:otherwise>居住城市:${user.sAddress}<input
								type="hidden" name="sAddress" value="${user.sAddress}" readonly>
						</c:otherwise>
					</c:choose>
				</h3>
				<h3>
				...
				<H3 align='center'>
					<a href="<c:url value='/member/GameIndex'/>"><input
						type="button" value="回首頁"
						style='background-color: skyblue; color: green;'></a>
				</H3>
			</form>
		</div>
	</div>
