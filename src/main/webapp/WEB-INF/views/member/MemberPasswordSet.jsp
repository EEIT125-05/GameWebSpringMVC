			...
			<div align='left'
				...
				<h3>
					輸入新密碼:<input id="Password" type="password" name="sPassword"
						minlength="8" required maxlength="16" onblur="checksPassword();"
						style="height: 50;"><input id="btn" type="button"
						class="material-icons" style="font-size: 25px;" value="visibility"><br>
				...
				<h3>
					再次確認密碼:<input id="passwordConfirm" type="password" name="password"
						...
						style="height: 50;"><br> <span id="idpasswordConfirm"></span>
				</h3>
				<h4 align='center' style='color: #FF0000;'>${showError}</h4>
				<H3 align='center' style="padding-top: 40;">
					<button id="submit" type="submit" name="submit" class="button">更改密碼</button>
				</H3>
